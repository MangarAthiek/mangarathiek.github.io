...
### Projects
Database Management System for Used-Car Dealership (JonesAuto) | Introduction to Database
Systems | 01/2026 – 04/2026 <br>
• Designed and implemented a relational database system to manage car purchases, sales,
warranties, and customer payments <br>
• Developed a full ER diagram and normalized schema to support complex business operations <br>
• Built MySQL database with sample data and enforced integrity constraints <br>
• Created PHP-based input forms and reports to simulate real-world business workflows <br>
• Developed 10+ SQL queries, including multi-table joins and subqueries, to answer business
questions (e.g., profitability, late payments, warranty usage)<br>
...
trends <br>
• Merged and cleaned large datasets using dplyr and tidyverse <br>
